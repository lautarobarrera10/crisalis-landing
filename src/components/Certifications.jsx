  ...
  return (
    <section id="certifications" className="py-20 lg:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-emerald-600 font-semibold text-sm tracking-widest uppercase">Documentación oficial</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-4xl mx-auto">
          {certs.map((cert, i) => (
            <motion.a
              ...
              viewport={{ once: true }}
              className="group flex flex-col items-center gap-4 p-6 bg-gray-50 border border-gray-200 rounded-2xl hover:border-emerald-400 hover:bg-emerald-50 hover:shadow-md transition-all"
            >
              {/* Icono PDF */}
              <div className="w-16 h-16 rounded-2xl bg-white border border-gray-200 group-hover:border-emerald-300 flex flex-col items-center justify-center shadow-sm transition-all">
                <DocumentArrowDownIcon className="w-7 h-7 text-emerald-600" />
